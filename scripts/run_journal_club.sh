...
export JOURNAL_CLUB_TIME_WINDOW_MONTHS="${JOURNAL_CLUB_TIME_WINDOW_MONTHS:-240}"
...
export JOURNAL_CLUB_MAX_ANALYSIS_WORKERS="${JOURNAL_CLUB_MAX_ANALYSIS_WORKERS:-4}"
export JOURNAL_CLUB_ENABLE_ANALYSIS_CACHE="${JOURNAL_CLUB_ENABLE_ANALYSIS_CACHE:-1}"
