...
DEDUP_ABSTRACT_PREFIX_LEN = int(os.getenv("JOURNAL_CLUB_LIT_DEDUP_ABSTRACT_PREFIX_LEN", "500"))

# If enabled, inhibitor-screening topics require closer inhibitor/target relevance.
STRICT_INHIBITOR_FILTER = os.getenv("JOURNAL_CLUB_LIT_STRICT_INHIBITOR_FILTER", "1").strip() != "0"
...
def _load_reranker():
    ...
    model_name = os.getenv(
        "JOURNAL_CLUB_RERANKER_MODEL",
        "cross-encoder/ms-marco-MiniLM-L-6-v2",
    )

    local_only = os.getenv("JOURNAL_CLUB_RERANKER_LOCAL_ONLY", "1").strip() == "1"
